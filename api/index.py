...
def get_blog(article_name):
    ...
    with open(article_file, encoding="utf-8") as file:
        ...
        created_at = datetime.datetime.fromtimestamp(os.path.getctime(article_file)).strftime("%d %B %Y, %I:%M %p")
        modified_at = datetime.datetime.fromtimestamp(os.path.getmtime(article_file)).strftime("%d %B %Y, %I:%M %p")
